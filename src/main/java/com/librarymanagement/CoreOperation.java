...
public class CoreOperation {
	...
	/**
	 * this method is used to view available
	 * number of books
	 */
	...
	/**
	 * this function updates everything according 
	 * to user's book takings
	 * @param quantity
	 * @param bookType
	 * @param id
	 * @return
...
/**
 * this function is responsible for showing 
 * books according to name of the book
 * @param bookName
 * @return
 */
public static int byName(String bookName)
{
	switch(bookName) {
